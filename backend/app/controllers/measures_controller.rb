class MeasuresController < ApplicationController
  ...
  private
    ...
    def measure_params
      params.require(:measure).permit(:patient_id, :hr, :grades, :minutes, :seconds, :steps, :accelerometer_X, :accelerometer_Y, :accelerometer_Z, :gyroscope_X, :gyroscope_Y, :gyroscope_Z)
    end
end
